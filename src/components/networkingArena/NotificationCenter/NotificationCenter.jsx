  ...
  return (
    <div 
      ...
      style={{
        ...
        right: 0,
        bottom: 0,
        background: 'rgba(189, 211, 55, 0.8)',
        display: 'flex',
    ...
    >
      <div 
        ...
        style={{
          ...
          background: '#FFFFFF',
          borderRadius: '24px',
          boxShadow: '0 20px 60px rgba(189, 211, 55, 0.4)',
          display: 'flex',
          flexDirection: 'column',
          border: '3px solid #BDD337',
          overflow: 'hidden',
      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            padding: '1.5rem',
            borderBottom: '2px solid #BDD337',
            background: 'linear-gradient(135deg, #BDD337, #524393)',
            color: '#FFFFFF'
          }}
        >
        ...
        {isLoading ? (
          ...
          >
            <div className="spinner" style={{
              width: '48px',
              height: '48px',
              border: '4px solid rgba(189, 211, 55, 0.2)',
              borderTopColor: '#BDD337',
              borderRadius: '50%',
                ...
                >
                  <div 
                    ...
                    style={{
                      ...
                      justifyContent: 'center',
                      marginBottom: '1.5rem',
                      boxShadow: '0 8px 16px rgba(189, 211, 55, 0.1), inset 0 -2px 8px rgba(0, 0, 0, 0.05)'
                    }}
                  >
                    <Bell size={48} style={{ color: '#BDD337', opacity: 0.4 }} />
                  </div>
