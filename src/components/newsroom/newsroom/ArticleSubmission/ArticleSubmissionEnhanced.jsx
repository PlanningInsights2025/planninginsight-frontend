...
const ArticleSubmissionEnhanced = () => {
  ...
  const validateForm = () => {
    ...
    // Plagiarism check validation - removed from UI
    // Plagiarism check will run automatically on backend
    // Admin will review plagiarism results in admin panel
  ...
  const handleSubmit = async (isDraft = false) => {
    ...
    try {
      ...
      // Backend will check and store results for admin review
        ...
        <div className="submission-layout">
          <div className="editor-main">
            <div className="editor-card">
              ...
              {/* Plagiarism Check - UI Hidden, runs automatically on backend */}
              {/* Plagiarism check happens silently during submission - only admins can view results */}
            </div>
          </div>
