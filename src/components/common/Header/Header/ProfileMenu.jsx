...
const ROWS = [
  { key: "dashboard", label: "Dashboard", Icon: DonutLargeRoundedIcon },
  { key: "profile", label: "My Profile", Icon: PersonOutlineRoundedIcon },
...
const ProfileMenu = ({
  ...
  const handleRowClick = (key) => {
    ...
    else if (key === "profile") onMyProfile && onMyProfile();
