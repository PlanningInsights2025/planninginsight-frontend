...
<p className="footer-description-horizontal">
  <strong>Planning Insights</strong> is a digital knowledge ecosystem for the built environment, designed to connect education, research, and professional practice on a single, integrated platform. We
