...
// Fallback placeholder export to avoid import errors while the full
// JobDetail implementation remains commented out above. Replace this
// temporary component with the real `JobDetail` when ready.
import React from 'react'

const JobDetailPlaceholder = () => (
	<div className="job-detail-unavailable" style={{padding:24}}>
		<h2>Job Detail (Unavailable)</h2>
		<p>The detailed Job page is temporarily unavailable. Please return to the Jobs list.</p>
	</div>
)

export default JobDetailPlaceholder