...
import { Search, ArrowRight, Users, Book, FileText, MessageSquare, Briefcase, Award, Clock, Star, MapPin, Calendar, ChevronRight, Zap, CheckCircle, BarChart, Globe, TrendingUp, Sparkles, Target, Rocket, ChevronsUp, X } from 'lucide-react'
import './Home.css'
...
const Home = () => {
  ...
  // FIX: Properly close modal and restore scroll
  ...
  // FIX: Handle navigation from modal with cleanup
  const handleNavigateFromModal = (path) => {
    closePlatformModal() // This will restore scroll
    navigate(path)
  }
          ...
          <div className="hero-content-enhanced">
            ...
            <div className="hero-text-enhanced">
              ...
              <p className="hero-description-enhanced">
                Join India's premier platform connecting urban planning professionals with opportunities, knowledge, and a thriving community. Access 2,500+ jobs, 450+ courses, and network with 15,000+ experts.
              </p>
              ...
              <div className="hero-search-enhanced">
                ...
                <div className="search-tags-enhanced">
                  ...
                  <button className="tag-btn" onClick={() => setSearchQuery('Urban Planner')}>Urban Planner</button>
                  <button className="tag-btn" onClick={() => setSearchQuery('Smart Cities')}>Smart Cities</button>
                  <button className="tag-btn" onClick={() => setSearchQuery('Sustainability')}>Sustainability</button>
                </div>
              </div>
              ...
              <div className="hero-actions-enhanced">
                {!isAuthenticated ? (
                  <>
                    <Link to="/register" className="btn-enhanced btn-primary-enhanced">
            ...
            <div className="hero-visual-enhanced">
              ...
              <div className="floating-stats-container">
                <div className="floating-stat-card-enhanced card-position-1">
                  <div className="card-icon-enhanced" style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
                ...
                <div className="floating-stat-card-enhanced card-position-2">
                  <div className="card-icon-enhanced" style={{ background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)' }}>
                ...
                <div className="floating-stat-card-enhanced card-position-3">
                  <div className="card-icon-enhanced" style={{ background: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)' }}>
                    <Users size={28} color="white" />
                  </div>
                  <div className="card-content-enhanced">
                    <div className="card-number-enhanced">{(stats.professionals / 1000).toFixed(0)}K+</div>
      ...
      <section className="features-section-autoscroll animate-on-scroll">
        <div className="container-full">
          <div className="section-header-professional">
            ...
            <h2>Discover All the <span className="text-gradient-professional">Tools & Resources</span></h2>
            <p>Comprehensive tools to advance your career in urban planning and built environment sectors</p>
          </div>
          ...
          <div className="platform-modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="platform-modal-body">
              ...
              <div className="platform-modal-actions">
                {/* FIX: Use handleNavigateFromModal instead of direct Link */}
                <button
      ...
      <section className="jobs-section-professional animate-on-scroll">
        <div className="container">
          <div className="section-header-professional">
            ...
            <h2>Discover Curated <span className="text-gradient-professional">Job Positions</span></h2>
            <p>From leading organizations seeking talented urban planning professionals</p>
          </div>

          <div className="jobs-grid-professional">
            {featuredJobs.map((job) => (
              <div key={job.id} className="job-card-professional">
                {job.urgent && (
      ...
      <section className="courses-section-professional animate-on-scroll">
        <div className="container">
          <div className="section-header-professional">
            ...
            <h2>Advance Your <span className="text-gradient-professional">Expertise</span></h2>
            <p>With industry-leading courses taught by expert instructors</p>
          </div>

          <div className="courses-grid-professional">
      ...
      <section className="testimonials-section-professional animate-on-scroll">
        <div className="container">
          <div className="section-header-professional">
            ...
            <h2>Join Thousands <span className="text-gradient-professional">Advancing Their Careers</span></h2>
            <p>Hear from professionals who transformed their careers with Planning Insights</p>
          </div>

          <div className="testimonials-grid-professional">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="testimonial-card-professional">
      ...
      <section className="cta-section-professional animate-on-scroll">
        <div className="container">
          <div className="cta-content-professional">
            ...
            <p>Join thousands of professionals leveraging Planning Insights to discover opportunities, develop skills, and build meaningful connections.</p>
            
            <div className="cta-actions-professional">
              {!isAuthenticated ? (
                <>
                  <Link to="/register" className="btn-professional btn-primary-professional btn-large-professional">
                    <span className="btn-shine" />
                    <span>Get Started Free</span>
                    <Rocket size={22} />
                  </Link>
            ...
            <p className="cta-note">
              Sign in to apply for jobs, enroll in courses, participate in discussions, and connect with 15,000+ professionals in your field.
            </p>
          </div>
        </div>
      </section>
